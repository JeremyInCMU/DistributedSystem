 ...
 * 
 */
@WebServiceClient(name = "SensorServer", targetNamespace = "http://jiamingx1.edu.cmu/", wsdlLocation = "http://localhost:8080/Project3Task2Server/SensorServer?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SENSORSERVER_QNAME = new QName("http://jiamingx1.edu.cmu/", "SensorServer");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Project3Task2Server/SensorServer?WSDL");
    ...
    public SensorServer getSensorServerPort() {
        return super.getPort(new QName("http://jiamingx1.edu.cmu/", "SensorServerPort"), SensorServer.class);
    }
    ...
    public SensorServer getSensorServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jiamingx1.edu.cmu/", "SensorServerPort"), SensorServer.class, features);
    }
