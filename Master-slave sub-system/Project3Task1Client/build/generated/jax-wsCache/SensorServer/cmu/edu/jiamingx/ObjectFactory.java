 ...
 * generated in the cmu.edu.jiamingx package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRoomStatusMsgResponse_QNAME = new QName("http://jiamingx.edu.cmu/", "getRoomStatusMsgResponse");
    private final static QName _RoomChangeinStatus_QNAME = new QName("http://jiamingx.edu.cmu/", "roomChangeinStatus");
    private final static QName _RoomChangeinStatusResponse_QNAME = new QName("http://jiamingx.edu.cmu/", "roomChangeinStatusResponse");
    private final static QName _GetRoomStatusMsg_QNAME = new QName("http://jiamingx.edu.cmu/", "getRoomStatusMsg");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cmu.edu.jiamingx
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jiamingx.edu.cmu/", name = "getRoomStatusMsgResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jiamingx.edu.cmu/", name = "roomChangeinStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jiamingx.edu.cmu/", name = "roomChangeinStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jiamingx.edu.cmu/", name = "getRoomStatusMsg")
